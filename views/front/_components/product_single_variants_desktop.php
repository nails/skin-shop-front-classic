...
$appSettingPriceExcludeTax = appSetting('price_exclude_tax', 'shop')
        ...
        <tbody>
            ...
            foreach ($product->variations as $variant) {
                ...
                if ($product->is_external) {
                    ...
                    ?>
                    <td>
                        <p itemprop="itemOffered"><?=$variant->label?></p>
                    ...
                    switch ($variant->stock_status) {
                        ...
                        case 'IN_STOCK':
                            ...
                            <td>
                                <p>
                                    <span itemprop="itemOffered"><?=$variant->label?></span>
                                    <meta itemprop="sku" content="<?=$variant->sku?>" />
                                    <?php
                            ...
                            <td>
                                ...
                                if ($appSettingPriceExcludeTax) {
                                    ...
                                    <p>
                                        <span itemprop="price">
                                            <?=$variant->price->price->user_formatted->value_ex_tax?>
                                        </span>
                                    </p>
                                    <?php
                                    ...
                                    <p>
                                        <span itemprop="price">
                                            <?=$variant->price->price->user_formatted->value_inc_tax?>
                                        </span>
                                    </p>
                                    <?php
                            ...
                            <td>
                                ...
                                if (!$this->shop_basket_model->isInBasket($variant->id)) {
                                    ...
                                    echo anchor(
                                        $shop_url . 'basket',
                                        'View Basket',
                                        'class="btn btn-xs btn-success pull-right btn-basket"'
                                    );
                                    echo form_submit(
                                        'submit',
                                        'Remove',
                                        'class="btn btn-xs btn-danger pull-right btn-remove"'
                                    );
                                    echo form_close();
                                }
                        ...
                        case 'TO_ORDER':
                            ...
                            <td>
                                ...
                                <p class="text-muted">
                                    <small>
                                        <em>Lead time: <?=$variant->lead_time?></em>
                                    </small>
                                </p>
                            </td>
                            <td>
